#!/usr/bin/env python3
# LOCAL-model baseline (no aux, no LLM bandit): repoints the stock Julia example at the
# vLLM Qwen2.5-32B server. Same knobs as the Go/circle/2048 baselines for comparability.
